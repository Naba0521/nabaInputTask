...
describe("selectCountry component",()=>{
    ...
    it("click",()=>{
        const{getByTestId}=render(<SelectedCountry selectedCountries={MockSetSelectedCountry} setSelectedCountries={MockSetSelectedCountries}/>)
        const deleteOneButton=getByTestId("delete-0")
        fireEvent.click(deleteOneButton)
        const deleteAllButton=getByTestId("clearAll")
